...
const Login = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-neutral-100 px-4">
      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-neutral-900/65 backdrop-blur-xl rounded-3xl border border-white/10 shadow-2xl">
        
        <div className='flex items-center justify-around'>
          <h2 className="text-2xl font-semibold text-center bg-white/5 border border-white/10 py-3 px-8 rounded-full text-neutral-100">Store Login</h2>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="block w-full px-3 py-2.5 bg-white/5 border border-white/10 rounded-xl shadow-sm placeholder-neutral-400 sm:text-sm text-neutral-100 disabled:opacity-70"
          ...
          <button
            type="submit"
            disabled={loading || lockoutTime > Date.now()}
            className="w-full flex justify-center py-2.5 px-4 border border-blue-400/20 rounded-xl shadow-sm text-sm font-medium text-white bg-blue-500 hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed"
          >
